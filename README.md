...
```bash
git clone https://github.com/ApparitionEmperor/shelly-1-gen4-matter-thread-740.git
cd shelly-1-gen4-matter-thread-740
...
Have a firmware variant or feature you'd like to see prioritized? [Vote on the roadmap discussion](https://github.com/ApparitionEmperor/shelly-1-gen4-matter-thread-740/discussions) or open an issue with your use case.
...
<!-- Last updated: 2026-06-06 16:08:11 -->
